...
public class DegradeRuleNacosPublisher extends AbstractNacosPublisher<List<DegradeRuleEntity>> {


    protected DegradeRuleNacosPublisher(NacosConfigClientProvider nacosConfigClientProvider, Converter<List<DegradeRuleEntity>, String> converter, NacosProperties nacosProperties) {
