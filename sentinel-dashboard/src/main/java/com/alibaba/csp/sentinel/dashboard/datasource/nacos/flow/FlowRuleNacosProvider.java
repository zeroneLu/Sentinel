...
public class FlowRuleNacosProvider extends AbstractNacosProvider<List<FlowRuleEntity>> {


    protected FlowRuleNacosProvider(NacosConfigClientProvider nacosConfigClientProvider, Converter<String, List<FlowRuleEntity>> converter, NacosProperties nacosProperties) {
