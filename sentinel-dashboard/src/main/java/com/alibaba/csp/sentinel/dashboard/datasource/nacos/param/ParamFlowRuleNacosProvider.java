...
public class ParamFlowRuleNacosProvider extends AbstractNacosProvider<List<ParamFlowRuleEntity>> {


    protected ParamFlowRuleNacosProvider(NacosConfigClientProvider nacosConfigClientProvider, Converter<String, List<ParamFlowRuleEntity>> converter, NacosProperties nacosProperties) {
