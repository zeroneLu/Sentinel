...
public class GatewayApiControllerV2 {
    ...
    private final DynamicRuleProvider<List<ApiDefinitionEntity>> ruleProvider;

    private final DynamicRulePublisher<List<ApiDefinitionEntity>> rulePublisher;

    public GatewayApiControllerV2(InMemApiDefinitionStore repository,
                                  @Qualifier("gatewayApiNacosProvider") DynamicRuleProvider<List<ApiDefinitionEntity>> ruleProvider,
                                  @Qualifier("gatewayApiNacosPublisher") DynamicRulePublisher<List<ApiDefinitionEntity>> rulePublisher) {
