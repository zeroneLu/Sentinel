 ...
 */
package com.alibaba.csp.sentinel.dashboard.datasource.nacos.param;
...
public class ParamFlowRuleNacosPublisher  extends AbstractNacosPublisher<List<ParamFlowRuleEntity>> {


    protected ParamFlowRuleNacosPublisher(NacosConfigClientProvider nacosConfigClientProvider, Converter<List<ParamFlowRuleEntity>, String> converter, NacosProperties nacosProperties) {
