 ...
 */
package com.alibaba.csp.sentinel.dashboard.datasource.nacos.flow;
...
public class FlowRuleNacosPublisher extends AbstractNacosPublisher<List<FlowRuleEntity>> {


    protected FlowRuleNacosPublisher(NacosConfigClientProvider nacosConfigClientProvider, Converter<List<FlowRuleEntity>, String> converter, NacosProperties nacosProperties) {
