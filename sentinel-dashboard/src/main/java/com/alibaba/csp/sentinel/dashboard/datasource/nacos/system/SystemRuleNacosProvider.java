...
public class SystemRuleNacosProvider extends AbstractNacosProvider<List<SystemRuleEntity>> {


    protected SystemRuleNacosProvider(NacosConfigClientProvider nacosConfigClientProvider, Converter<String, List<SystemRuleEntity>> converter, NacosProperties nacosProperties) {
