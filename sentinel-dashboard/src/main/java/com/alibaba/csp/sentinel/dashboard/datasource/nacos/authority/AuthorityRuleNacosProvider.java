...
public class AuthorityRuleNacosProvider extends AbstractNacosProvider<List<AuthorityRuleEntity>> {


    protected AuthorityRuleNacosProvider(NacosConfigClientProvider nacosConfigClientProvider, Converter<String, List<AuthorityRuleEntity>> converter, NacosProperties nacosProperties) {
