 ...
 */
package com.alibaba.csp.sentinel.dashboard.datasource.nacos.system;
...
public class SystemRuleNacosPublisher extends AbstractNacosPublisher<List<SystemRuleEntity>> {


    protected SystemRuleNacosPublisher(NacosConfigClientProvider nacosConfigClientProvider, Converter<List<SystemRuleEntity>, String> converter, NacosProperties nacosProperties) {
